...
def resnet18(num_classes: int = 10, img_channels: int = 3, low_resolution: bool = False) -> ResNet:
...
def resnet34(num_classes: int = 10, img_channels: int = 3, low_resolution: bool = False) -> ResNet:
...
def resnet50(num_classes: int = 10, img_channels: int = 3, low_resolution: bool = False) -> ResNet:
