...
class NetLinLayer(nn.Module):
    r""" A single linear layer which does a 1x1 conv """
...
class PNetLin(nn.Module):
    def __init__(self, pnet_type='vgg', pnet_rand=False, pnet_tune=False, use_dropout=True, use_gpu=True, spatial=False,
                 version='0.1', colorspace='RGB', reduction='none'):
